...
```{r, include=TRUE, fig.cap="Each point indicates the estimated number of IDUs in the Philadelphia area based on the visits Prevention Point recorded in a given month. The lines indicate the 95% confidence intervals of the estimates."}
month_est_list <- list(
  jan_est,
  feb_est,
  mar_est,
