...
Using the counts of overdoes deaths, we replicated the estimate conducted in ["Estimating the Prevalence of Opioid use Disorder in the Cincinnati Region using Probabilistic Multiplier Methods and Model Averaging."](https://jheor.org/article/9729-estimating-the-prevalence-of-opioid-use-disorder-in-the-cincinnati-region-using-probabilistic-multiplier-methods-and-model-averaging) In the example to follow, the same multiplier was used as in the cited study.
